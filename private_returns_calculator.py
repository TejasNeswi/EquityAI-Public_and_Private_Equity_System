...
print(f"Expected Final Value (mean): {simulated_returns.mean():.2f} Million USD")
print(f"Median Final Value: {np.median(simulated_returns):.2f} Million USD")
print(f"5th percentile (pessimistic): {np.percentile(simulated_returns, 5):.2f} Million USD")
print(f"95th percentile (optimistic): {np.percentile(simulated_returns, 95):.2f} Million USD")
